...
def main():
    ...
    # Ensure the training and validation sets are disjoint and have the correct relative sizes
    subset_indices_train, subset_indices_valid = train_valid_split(train_dataset)
